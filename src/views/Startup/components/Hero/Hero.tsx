      ...
      <Box width={1} height={1} position={'absolute'} overflow={'hidden'}>
        ...
        >
          <iframe
            ...
            width="100%"
            height="100%"
            src="https://www.youtube.com/embed/mIx19y8eO10?autoplay=1&controls=0&showinfo=0&mute=1&loop=1&playlist=mIx19y8eO10"
          />
        </Box>
      </Box>
      <Box
        ...
        <Container position={'relative'} zIndex={4}>
          <Box>
            <Box marginBottom={4}>
              ...
              >
                We develop robust A.I. and technology solutions
              </Typography>
              <Typography
                variant={'h6'}
                align={'center'}
              ...
              >
                We research, develop and deploy A.I. and technology solutions for our clients.
              </Typography>
            </Box>
            {/* <Box
              padding={{ xs: 3, sm: 6 }}
